...
namespace YC5.Data
{
    public static class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            // 2. (Đã bỏ qua kiểm tra global context.Users.Any() để cho phép seed thêm dữ liệu nếu thiếu)
            ...
            // Kiểm tra xem Role Administrator đã có Function chưa, nếu chưa thì gán
            var adminRoleForFunc = context.Roles.FirstOrDefault(r => r.Name == "Administrator");
            if (adminRoleForFunc != null && !context.RoleFunctions.Any(rf => rf.RoleId == adminRoleForFunc.Id))
            {
